...
const AdminOverview = () => {
  ...
  const cards = [
    ...
    ['Learning spaces', metrics.courses.toLocaleString(), `${metrics.quizzes} platform quizzes`, 'from-primary-600 to-accent-500'],
    ['Assessment activity', metrics.attempts.toLocaleString(), 'Quiz attempts recorded platform-wide', 'from-primary-700 to-primary-400'],
    ['Integrity events', metrics.violations.toLocaleString(), `${metrics.suspendedUsers} suspended accounts`, 'from-accent-600 to-primary-500'],
  ];
  return <div className="mx-auto max-w-7xl space-y-7">
    <section className="relative overflow-hidden rounded-[2rem] bg-ink-950 p-7 ring-1 ring-white/10 sm:p-10" style={{ backgroundImage: 'radial-gradient(65% 100% at 0% 0%, rgba(16,185,129,.22), transparent 58%), radial-gradient(50% 90% at 100% 100%, rgba(6,182,212,.16), transparent 58%)' }}>
